        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              Explore our achievements, media coverage, and recognition in the
              legal industry
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto text-lg">
              Dive into our collection of impactful news coverage, legal
              breakthroughs, and public recognition through authentic press
              clippings.
            </p>
          </div>
          ...
          {newspaperImages.length === 0 && (
            <div className="text-center py-20">
              ...
              <p className="text-slate-600">
                Check back later for updates to our media gallery.
              </p>
            </div>
          )}
        </div>
